  ...
  return (
    <div className="flex w-full flex-col  text-green-dark z-0 h-[30rem] md:h-[25rem] md:mt-[1.25rem] animate-showUp  lg:h-[34rem]" id='Home'>
      ...
      <div className='flex flex-row w-full '>
        <div className='flex flex-col absolute top-[5.5rem] left-[0.78rem] w-1/4 gap-3  md:top-[8.25rem] lg:left-[12rem] lg:top-[13rem]
  '>
        ...
        <div className='w-[100%] group   '>
          <div class="w-[10rem] h-[10rem] relative top-11 left-[5rem] rounded-full bg-green-light md:top-[5rem]  md:left-[25rem]
          lg:w-[15rem] lg:h-[15rem] lg:left-[45rem] lg:top-[8rem]
          ">
      ...
      <div className="flex flex-col gap-3 relative top-12 md:top-[-6.75rem] md:left-[3.5rem] lg:left-[15rem]">
