...
function Services() {
  return (
    <div className='h-content  '>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 place-items-left ml-2 '>

        <div className='rounded-lg w-full h-[12rem]  '>
        <BiCodeCurly  className='text-[1.8rem] relative  top-7 left-3'/>
          <h1 className='text-center  font-bold text-[22px]'>
            FrontEnd Dev  </h1>
          

          <p className='text-sm md:text-base lg:text-lg=font-semibold ml-3'>
